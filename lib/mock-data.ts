...
export const researchRuns: ResearchRun[] = [
  { id: "run_104", ideaName: "CloseSignal", ideaDescription: closeSignal.oneLiner, targetCustomer: closeSignal.targetCustomer, marketType: "B2B", targetRegion: "United States", mode: "Deep Validation", status: "Complete", createdAt: "2026-07-09", progress: 100, opportunity: closeSignal },
  { id: "run_103", ideaName: "ProposalOS", ideaDescription: "A proposal follow-up assistant for independent agencies.", targetCustomer: "Boutique creative agencies", marketType: "Agency Tool", targetRegion: "English-speaking markets", mode: "Fast Scan", status: "Complete", createdAt: "2026-07-05", progress: 100 },
  { id: "run_102", ideaName: "LessonLoop", ideaDescription: "A retention dashboard for cohort course creators.", targetCustomer: "Course creators", marketType: "Creator", targetRegion: "Global", mode: "Fast Scan", status: "Complete", createdAt: "2026-06-28", progress: 100 },
];
