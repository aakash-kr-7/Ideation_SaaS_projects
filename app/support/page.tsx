...
export default function SupportPage() {
  return <main className="support-page">
    ...
    <section className="support-hero">
      ...
      <p>For account, report, entitlement, or privacy questions, email the ShouldBuild support team. Paid checkout is not currently available.</p>
    ...
    <section className="support-grid">
      ...
      <article><ReceiptText size={19}/><h2>Payments status</h2><p>Paid checkout is unavailable. Report any unexpected ShouldBuild charge descriptor without sending complete card details.</p><Link href="/legal/refunds">Review payments status</Link></article>
